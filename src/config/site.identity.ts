export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'victorbogado',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Victorbogado',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'victorbogado.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://victorbogado.com',
