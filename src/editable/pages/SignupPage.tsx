...
const perks = ['Build your own collection of resources', 'Submit links for the whole community', 'Free forever — no card required']
    ...
    <EditableSiteShell>
      <main className="bg-[var(--slot4-cream)] text-[var(--slot4-page-text)]">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[var(--editable-container)] items-center gap-12 px-5 py-16 sm:px-6 lg:grid-cols-2 lg:px-8">
          {/* Form card */}
          <div className="order-2 mx-auto w-full max-w-md rounded-[var(--editable-radius-xl)] border border-[var(--editable-border)] bg-[var(--slot4-surface-bg)] p-7 shadow-[var(--editable-shadow)] sm:p-9 lg:order-1">
            ...
            <p className="mt-2 text-sm text-[var(--slot4-muted-text)]">Join in seconds and start curating.</p>
          ...
          {/* Brand / value panel */}
          <div className="relative order-1 hidden overflow-hidden rounded-[var(--editable-radius-xl)] bg-[var(--slot4-ink)] p-10 text-white shadow-[var(--editable-shadow-lg)] lg:order-2 lg:block lg:p-12">
            <div className="pointer-events-none absolute -left-16 -bottom-16 h-64 w-64 rounded-full bg-[radial-gradient(closest-side,rgba(211,35,35,0.4),transparent)]" />
